...
> 💡 **Pista:** Los datos deben estar en formato Tabla (Ctrl+T) para que las tablas dinámicas se expandan automáticamente al añadir nuevos registros. Los segmentadores se insertan desde Analizar > Insertar segmentador. La línea de tiempo requiere que el campo de fecha esté en formato de fecha válido. Conecta todos los elementos a la misma tabla dinámica para que los filtros se sincronicen.
