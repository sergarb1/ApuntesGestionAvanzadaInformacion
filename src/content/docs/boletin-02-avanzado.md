...
PV es lo que debería haberse gastado según lo planificado. EV es el valor del trabajo realmente completado. AC es lo que realmente se ha gastado. Compara EV vs AC para ver desviación de coste (CV) y EV vs PV para ver desviación de plazo (SV). CPI = EV/AC, si es menor que 1 hay sobrecoste. El EAC = BAC/CPI pronostica el coste final.
