...
Piensa en las grandes áreas de trabajo: diseño del producto, fabricación, comercialización y soporte. Cada una debe descomponerse en tareas concretas y medibles. Recuerda la regla del 100%: el nivel superior debe incluir todo el trabajo de los niveles inferiores.
...
Dibuja una línea de tiempo en semanas. Coloca cada tarea como una barra horizontal cuya longitud representa su duración. Conecta las tareas según las dependencias. Identifica qué tareas no tienen margen (camino crítico) - son las que determinan la duración total del proyecto.
...
Los riesgos pueden ser técnicos (fallos de producto), de mercado (baja aceptación), de plazo (retrasos) o de recursos (falta de personal). La mitigación debe ser una acción que reduzca la probabilidad o el impacto del riesgo, no una simple declaración de intenciones.
...
Para los costes de personal, multiplica días estimados por coste diario de cada rol. Suma todos los costes directos y aplica el porcentaje de contingencia. El presupuesto final debe reflejar la suma de costes directos más contingencia. Justifica brevemente cada partida.
