...
> 💡 **Pista:** Piensa en las grandes áreas de trabajo: diseño del producto, fabricación, comercialización y soporte. Cada una debe descomponerse en tareas concretas y medibles. Recuerda la regla del 100%: el nivel superior debe incluir todo el trabajo de los niveles inferiores.
...
> 💡 **Pista:** Dibuja una línea de tiempo en semanas. Coloca cada tarea como una barra horizontal cuya longitud representa su duración. Conecta las tareas según las dependencias. Identifica qué tareas no tienen margen (camino crítico) - son las que determinan la duración total del proyecto.
...
> 💡 **Pista:** Los riesgos pueden ser técnicos (fallos de producto), de mercado (baja aceptación), de plazo (retrasos) o de recursos (falta de personal). La mitigación debe ser una acción que reduzca la probabilidad o el impacto del riesgo, no una simple declaración de intenciones.
