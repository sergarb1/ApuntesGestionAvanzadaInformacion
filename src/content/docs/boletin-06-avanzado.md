...
Los equipos de Dirección y RRHH suelen manejar información confidencial. Los canales privados son útiles dentro de un equipo público cuando solo un subgrupo debe acceder a ciertos contenidos.
...
Necesitarás los conectores "Programación", "Planner" y "Teams". El flujo debe obtener las tareas no completadas y luego publicarlas formateadas como mensaje. Usa "Aplicar a cada" para iterar.
...
La opción de grabación automática está en "Opciones de reunión". Las grabaciones se guardan en OneDrive del organizador por defecto; tendrás que configurar el destino en SharePoint del equipo.
...
El desafío está en la asignación condicional. Usa una "Condición" o "Cambiar" en Power Automate para bifurcar según el producto. Necesitarás Forms, SharePoint, Planner y Teams como conectores. Ten en cuenta los límites de concurrencia al procesar el formulario.
