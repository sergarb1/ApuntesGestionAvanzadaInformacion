...
> 💡 **Pista:** Organiza los flujos de caja en una tabla año a año. Recuerda que el VAN descuenta los flujos futuros a su valor presente. Un VAN positivo indica que el proyecto genera valor. Para el payback, calcula cuándo se recupera la inversión acumulada. El ROI se expresa como porcentaje sobre la inversión inicial.
...
> 💡 **Pista:** Comienza identificando qué conocimiento es crítico para la empresa (el que se pierde cuando alguien se va). Luego, piensa en herramientas para capturarlo (grabaciones, documentos, entrevistas) y estrategias para transferirlo (mentorías, comunidades, rotación). Los indicadores deben medir si el conocimiento se está reteniendo efectivamente.
...
> 💡 **Pista:** El modelo Kotter empieza creando urgencia (¿por qué el cambio es necesario?) y termina anclando el cambio en la cultura. Piensa en la resistencia al cambio típica de una empresa tradicional. Cada paso debe traducirse en una acción tangible: ¿qué harías concretamente el lunes para crear urgencia?
