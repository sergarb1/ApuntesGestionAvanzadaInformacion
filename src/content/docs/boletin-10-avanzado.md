---
title: "Boletín 10 - Nivel Avanzado: Proyecto Knowledge Management (I)"
---
...
Las fortalezas y debilidades son internas (equipo, recursos, cultura). Las oportunidades y amenazas son externas (mercado, normativa, competencia). El valor está en el cruce estratégico FO y DA, no en el listado aislado.
...
Cada grupo necesita un mensaje y un canal diferente. La dirección quiere datos concretos; los empleados necesitan entender el beneficio personal; los proveedores y clientes solo requieren una notificación clara. La resistencia al cambio se gestiona con comunicación temprana y formación, no con imposiciones.
...
Cuantifica primero el coste de la situación actual (horas perdidas × coste/hora). La inversión del proyecto incluye licencias, consultoría y formación. El ROI se calcula como (ahorro - inversión) / inversión × 100. El payback es inversión inicial / ahorro mensual.
