---
title: "Boletín 08 - Nivel Fácil: Archivo digital: cómo organizar los documentos de la empresa"
---
...
1. **Clasificar documentos según un cuadro de clasificación**
   ...
   > 💡 **Pista:** Pregúntate cuál es la función principal de cada documento dentro de la empresa. El nombre de cada serie documental te da una pista clara de su contenido.
...
2. **Crear una estructura de carpetas para el archivo digital**
   ...
   > 💡 **Pista:** Piensa en jerarquías de 2 o 3 niveles como máximo. Agrupa primero por función del departamento y luego por tipo o año. Dibuja el árbol de carpetas antes de crearlo.
...
3. **Nombrar archivos siguiendo una convención**
   ...
   > 💡 **Pista:** El formato ISO de fecha (AAAAMMDD) ordena los archivos cronológicamente aunque estén en la misma carpeta. Evita palabras como "final" o "definitivo" y usa números de versión.
