---
title: "Boletín 07 - Nivel Fácil: Oficina virtual y página web de la empresa"
---
...
1. **Crear una página básica en WordPress**
   ...
   > 💡 **Pista:** La opción "Páginas" está en el menú lateral del panel de administración. Para que aparezca en el menú principal, ve a "Apariencia" → "Menús".
...
2. **Configurar un formulario de contacto**
   ...
   > 💡 **Pista:** Después de instalar y activar el plugin, aparecerá una nueva opción "Contacto" en el menú. El shortcode del formulario se genera automáticamente y puedes copiarlo para pegarlo en cualquier página.
...
3. **Crear una intranet básica con Google Sites**
   ...
   > 💡 **Pista:** En Google Sites, el botón "Publicar" está en la esquina superior derecha. En las opciones de publicación puedes elegir quién puede ver el sitio. Selecciona "Restringido" y el dominio corporativo.
...
4. **Añadir y configurar un plugin de seguridad**
   ...
   > 💡 **Pista:** Una vez activado, encontrarás "Wordfence" en el menú lateral. El escaneo se inicia desde la subpestaña "Scan". Las opciones de programación están en "Opciones de escaneo".
