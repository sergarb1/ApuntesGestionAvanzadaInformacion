---
title: "Boletín 10 - Nivel Fácil: Proyecto Knowledge Management (I)"
---
...
1. **Redactar la introducción de una memoria de proyecto**
   ...
   > 💡 **Pista:** Piensa en una empresa real o ficticia. Describe brevemente a qué se dedica y cuántos empleados tiene. La problemática debe ser concreta: pérdida de tiempo, duplicados, riesgo legal. Los objetivos deben empezar con verbos como "implantar", "definir", "establecer".
...
2. **Preparar un resumen ejecutivo para la dirección**
   ...
   > 💡 **Pista:** La dirección no necesita todos los detalles técnicos. Responde solo a: ¿qué problema resuelve?, ¿cuánto cuesta?, ¿en cuánto tiempo?, ¿qué beneficio obtenemos? Incluye cifras concretas de ahorro o retorno de inversión.
...
3. **Crear un cronograma de proyecto con hitos clave**
   ...
   > 💡 **Pista:** Ordena las fases de forma lógica: primero analizar, luego diseñar, después configurar, migrar, formar y finalmente poner en marcha. Cada hito debe ser algo verificable: un informe aprobado, un sistema configurado, unos empleados formados.
