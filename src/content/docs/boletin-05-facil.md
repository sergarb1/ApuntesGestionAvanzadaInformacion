...
> 💡 **Pista:** Un guion de 60 segundos debe tener entre 120 y 150 palabras de voz en off. Organiza las escenas en una tabla con columnas para tiempo, descripción visual, audio y texto en pantalla. Planifica los planos: general (contexto), medio (personas), primer plano (detalle, emotividad).
...
> 💡 **Pista:** Piensa en el recorrido del usuario desde que abre la app por primera vez hasta que completa una acción. Cada viñeta debe representar una pantalla o interacción clave. La voz en off debe explicar lo que el usuario ve en pantalla, no repetirlo. Evita más de 15-20 segundos por viñeta.
...
> 💡 **Pista:** Antes de grabar, limpia tu escritorio y cierra aplicaciones que no sean relevantes. La estructura ideal para un screencast formativo es: "qué vamos a aprender" → "paso 1, paso 2, paso 3" → "resumen". Las anotaciones (flechas, círculos) deben aparecer justo cuando se menciona el elemento, no antes ni después.
